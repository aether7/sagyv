...
urlpatterns = patterns("guias.views",
    url(r"^$", "index", name="index"),
)

urlpatterns += patterns("guias.terminales_views",
...
urlpatterns += patterns("guias.talonarios_views",
...
urlpatterns += patterns("guias.guias_views",
