...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogSistema'
        db.create_table(u'main_logsistema', (
            ...
            ('tabla', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'main', ['LogSistema'])


    def backwards(self, orm):
        # Deleting model 'LogSistema'
        db.delete_table(u'main_logsistema')
